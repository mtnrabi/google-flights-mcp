...
PRODUCT_CONTEXT: dict[str, dict[str, str]] = {
    "flights": {
        ...
        "TOOL_BEHAVIOUR": (
            ...
            "rising automatically to as many as 300 when the request itself "
            "is larger -- a whole month of departures at three trip lengths "
            "is 93, and the same month across three destinations is 279; a "
            "per-call `max_searches` argument sets the figure "
            "explicitly, up or down, and 300 is the hard ceiling), and "
...
PRODUCT_CONTEXT["both"] = dict(
    ...
    TOOL_BEHAVIOUR=(
        ...
        "default, rising automatically to as many as 300 when the request "
        "itself is larger -- a whole month of departures at three trip "
        "lengths is 93, and the same month across three destinations is 279; "
        "a per-call `max_searches` argument sets the figure "
        "explicitly, up or down, and 300 is the hard ceiling), forwarding "
